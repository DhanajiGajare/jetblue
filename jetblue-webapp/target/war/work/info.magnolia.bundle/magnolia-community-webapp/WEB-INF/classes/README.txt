...
This package contains:
   ...
   Magnolia Core 5.7
   magnolia-empty-webapp 5.7
   magnolia-empty-webapp 5.7
   Magnolia Internationalization Framework 5.7
   Magnolia JAAS 5.7
   Google Sitemap Module 2.5
   magnolia-module-mail 5.5
   magnolia-module-rssaggregator 2.6
   Magnolia Rendering 5.7
   Magnolia Templating 5.7
   Magnolia Templating for JSP 5.7
...
More information about this release can be found at:
    http://documentation.magnolia-cms.com/releases/5.7.html
